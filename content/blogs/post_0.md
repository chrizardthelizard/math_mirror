...
## Current Algorithm
```bash
# generate output folder using config file
pelican content -o output -s pelicanconf.py 
```
# add output html/etc files to gh-pages branch
# generates github actions workflow for publishing automatically
```bash
ghp-import output -b gh-pages 
```

# push the branch and check your website
```bash
